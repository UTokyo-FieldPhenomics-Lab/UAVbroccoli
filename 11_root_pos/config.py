...
dom_slice_save_folder = f"{project_data_folder}/10_root_position"
...
labelme_json_data_pool = {
    ...
    "2021a":f"{project_data_folder}/10_root_position/labelme_json",  # 2021 autumn train data
...
train_database_path = f"{project_data_folder}/10_root_position/yolo_train/training_database"
# optional
...
yolo_model_structure_config = "models/yolov5s.yaml"
yolo_model_name = "br"
yolo_model_save_path = f"{project_data_folder}/10_root_position/yolo_train/runs"


#######################
# 04 apply yolo model #
#######################
yolo_apply_results_folder = f"{project_data_folder}/10_root_position/yolo_results"
...
shapefile_save_folder = f"{project_data_folder}/10_root_position/shapefiles"
